...
import it.eda.shipments.producer.controller.model.Session;
...
public class RedisSessionService {
    ...
    public Uni<Optional<Session>> getSession(String sessionId) {
        ...
        return commands.hgetall("session:" + sessionId)
                ...
                .onFailure().invoke(e -> log.error("Errore nel recuperare la sessione per sessionId: {}. Dettaglio errore: {}", sessionId, e.getMessage()));
    }
